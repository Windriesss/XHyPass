...
/*
 * Notify Xen that a guest critical section which deferred a scheduling
 * decision has ended. Unlike SCHEDOP_yield, this does not voluntarily give
 * up the VCPU allocation; it only revisits an already-pending decision.
 * @arg == NULL.
 */
#define SCHEDOP_deferred_preempt_ready 8
/* ` } */
