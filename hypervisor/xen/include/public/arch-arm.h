...
/*
 * XHyPass guest control HVC. x0 contains one of XEN_XHYPASS_* and x1
 * contains the reserved event SGI for XEN_XHYPASS_ENTER_RTO.
 * The return value is written to x0.
 */
#define XEN_HYPERCALL_XHYPASS   0x4A48
#define XEN_XHYPASS_ENTER_RTO   12
#define XEN_XHYPASS_EXIT_RTO    13
