...
struct arch_vcpu
{
    ...
    /* Physical CPU-interface state replaced while this vCPU is in RTO mode. */
    struct {
        register_t hcr_el2;
        register_t ich_hcr_el2;
        register_t icc_ctlr_el1;
        register_t icc_igrpen1_el1;
        register_t icc_pmr_el1;
        register_t icc_bpr1_el1;
    } rto_gic;
